...
def home(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render('process.html', {'outputfilename': outputfilename},
                                      context_instance=RequestContext(request))
    else:
        form = UploadFileForm()
    return render('index.html', {'form': form}, context_instance=RequestContext(request))


def process(request):
    return render('process.html', {})
